...
import br.com.datasol.vendasmcel.conexaoweb.ConexaoHTTPClient;
...
public class ReplicarClientesIn extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
        	...
        	//url= url + "/ListarClientes.jsp?vendedor=" + vendedor; //11.05.2016
	        url= url + "/ReplicarClientesOff.jsp?vendedor=" + vendedor;
/*        	        	
...
//						CAMPO E LAVOURA|A. R. DOS ANGELOS ME@17.775.485/0001-98$N*PARECIS%#
						int codc = nome.indexOf("{"); 
	                    codcli = nome.substring(0, codc);	                    
	                    codc = codc + 1;
						int us = nome.indexOf("|"); 
	                    usuario = nome.substring(codc, us);	                    
	                    us = us + 1;
	                    int r = nome.indexOf("@");
	                    ...
	                    atrasoinfo = nome.substring(cn, patr);
	                    patr = patr + 1;
	                    int ci = nome.indexOf("%");
