...
public class ListarVendasNaoSincronizadas extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vendaslistarnaosincronizadas);
		...
		btAddItens.setVisibility(View.INVISIBLE);
		...
		etProcurar.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				lvVendaC.setAdapter(new ArrayAdapter<String>(ListarVendasNaoSincronizadas.this,
		...
		lvVendaC.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView arg0, View view, int position,
				...
				Builder msg = new Builder(ListarVendasNaoSincronizadas.this);
	...
	public void BuscarVendasC(){
		...
		cVendaC = db.rawQuery("SELECT COD, FANTASIA, RAZAO, DATAEMS, CIDA, VENDEDOR, TOT from REC where sincronizado='N' order by COD desc", null);
...
*/		
	...
	public void enviaIDVendaC(){
		Intent intent = new Intent(this, VendaD.class);
		
		Bundle parametros = new Bundle();
		parametros.putString("idvendac1", idVendaC);
