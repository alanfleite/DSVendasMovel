...
public class ListarVendasSincronizadas extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vendaslistarsincronizadas);
		...
		etProcurar.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				lvVendaC.setAdapter(new ArrayAdapter<String>(ListarVendasSincronizadas.this,
		...
		lvVendaC.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView arg0, View view, int position,
				...
				Builder msg = new Builder(ListarVendasSincronizadas.this);
	...
	public void BuscarVendasC(){
		...
		cVendaC = db.rawQuery("SELECT COD, FANTASIA, RAZAO, DATAEMS, CIDA, VENDEDOR, TOT from REC where sincronizado='S' order by COD desc", null);
